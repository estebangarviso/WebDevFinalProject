...
class MutableBundleGraph extends _BundleGraph().default {
  ...
  createBundleGroup(dependency, target) {
    ...
    let bundleGroupNodeId = _classPrivateFieldGet(this, _graph)._graph.addNodeByContentKey(bundleGroupNode.id, bundleGroupNode);
    ...
    if (dependency.isEntry || resolved.bundleBehavior === _types().BundleBehavior.isolated) {
  ...
  createBundle(opts) {
    var _opts$uniqueKey, _opts$type, _opts$pipeline, _opts$isSplittable;
    ...
    let bundleId = (0, _hash().hashString)('bundle:' + ((_opts$uniqueKey = opts.uniqueKey) !== null && _opts$uniqueKey !== void 0 ? _opts$uniqueKey : (0, _nullthrows().default)(entryAsset === null || entryAsset === void 0 ? void 0 : entryAsset.id)) + _path().default.relative(_classPrivateFieldGet(this, _options).projectRoot, target.distDir));
    ...
    let bundleNode = {
      ...
      value: {
        ...
        pipeline: (_opts$pipeline = opts.pipeline) !== null && _opts$pipeline !== void 0 ? _opts$pipeline : entryAsset === null || entryAsset === void 0 ? void 0 : entryAsset.pipeline,
        isEntry: opts.isEntry,
        isInline: opts.isInline,
        isSplittable: (_opts$isSplittable = opts.isSplittable) !== null && _opts$isSplittable !== void 0 ? _opts$isSplittable : entryAsset === null || entryAsset === void 0 ? void 0 : entryAsset.isBundleSplittable,
        isPlaceholder,
        target,
        name: null,
        displayName: null,
