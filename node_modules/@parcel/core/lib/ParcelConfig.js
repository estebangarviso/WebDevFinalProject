...
class ParcelConfig {
  constructor(config, options) {
    ...
    _defineProperty(this, "regexCache", void 0);
  ...
  _loadPlugin(node) {
    ...
    plugin = (0, _loadParcelPlugin().default)(node.packageName, node.resolveFrom, node.keyPath, this.options);
  ...
  _getTransformerNodes(filePath, pipeline, allowEmpty) {
    ...
    if (!transformers || transformers.length === 0) {
      ...
      throw new Error(`No transformers found for ${filePath}` + (pipeline != null ? ` with pipeline: '${pipeline}'` : '') + '.');
    }
