...
class DevPackager {
  ...
  async package() {
    ...
    if (this.bundle.env.sourceType === 'script' && script) {
      ...
      if (mapBuffer) {
        entryMap = new (_sourceMap().default)(mapBuffer);
      }
  ...
  isEntry() {
    ...
    return !this.bundleGraph.hasParentBundleOfType(this.bundle, 'js') || this.bundle.env.isIsolated() || !!((_this$bundle$getMainE = this.bundle.getMainEntry()) !== null && _this$bundle$getMainE !== void 0 && _this$bundle$getMainE.bundleBehavior) === 'isolated';
  }
