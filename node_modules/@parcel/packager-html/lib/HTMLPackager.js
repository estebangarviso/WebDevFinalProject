...
var _default = new (_plugin().Packager)({
  ...
  async package({
    ...
    let {
      html
    } = await (0, _posthtml().default)([insertBundleReferences.bind(this, referencedBundles), replaceInlineAssetContent.bind(this, bundleGraph, getInlineBundleContents)]).process(code, renderConfig);
    let {
      contents,
      map
...
async function replaceInlineAssetContent(bundleGraph, getInlineBundleContents, tree) {
  ...
  for (let node of inlineNodes) {
    ...
    if (newContent != null) {
      ...
      if ((0, _nullthrows().default)(bundle).env.outputFormat === 'esmodule') {
